...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { event_id: @table.event_id, max_seats: @table.max_seats, number: @table.number }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { event_id: @table.event_id, max_seats: @table.max_seats, number: @table.number }
    assert_redirected_to table_path(assigns(:table))
  end
